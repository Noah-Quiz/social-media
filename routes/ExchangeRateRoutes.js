 ...
 *     security:
 *      - bearerAuth: []
 *     summary: Update an exchange rate value and description based on name
 *     tags: [ExchangeRates]
 *     requestBody:
 *       required: true
 *       content:
 ...
 *                 description: "Name of the exchange rate."
 *               value:
 *                 type: number
 *                 required: false
 *                 example: 1
 ...
 *                   example: "Success"
 *       400:
 *         description: Bad request. Examples include missing fields or invalid `name`.
 *       500:
 *         description: Internal server error.
 */
...
/**
 * @swagger
 * /api/exchange-rate/by-id:
 *   put:
 *     security:
 *      - bearerAuth: []
 *     summary: Update an exchange rate value and description based on ID
 *     tags: [ExchangeRates]
 *     requestBody:
 *       required: true
 *       content:
 ...
 *                   example: "Success"
 *       400:
 *         description: Bad request. Examples include missing fields or invalid `id`.
 *       500:
 *         description: Internal server error.
 */
 ...
 *     security:
 *      - bearerAuth: []
 *     summary: Get a single exchange rate by ID
 *     tags: [ExchangeRates]
 *     parameters:
 *       - in: query
 *         name: id
 ...
 *         description: Internal server error
 */
exchangeRateRoutes.get("/by-id", exchangeRateController.getOneExchangeRate);
 ...
 *     security:
 *      - bearerAuth: []
 *     summary: Get a single exchange rate by name
 *     tags: [ExchangeRates]
 *     parameters:
 *       - in: query
 *         name: name
...
exchangeRateRoutes.get("/by-name", exchangeRateController.getOneExchangeRate);
